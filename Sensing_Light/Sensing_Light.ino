...
void loop()
{
    ...
    // Note: voltage divider eqn:
    /*
        V0 = Vi * ( R2 / (R1+R2) )
        
        "output voltage is a fixed fraction of the input voltage. The ratio is determined by two resistors" - khanacademy
    */

    // Also: more light ==> less resistance     
